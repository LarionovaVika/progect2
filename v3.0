    ...
    if q == 1:
        ...
        if c == 1:
            ...
            if a == 'Тихо осмотреть дом и поискать крестик':
                ...
                k = 1
                break
    print('Ты достал все нужные для тебя предметы. Теперь тебе нужно отправиться к колдуну. Ты попрощался с конюхом и пошел к замку.')
    print('Вы дошли до замка. Вы заходите туда.')
    print('Тёмный, мрачный коридор. Вы проходите по нему на цыпочках.')
    print('Как бессонница в час ночной')
    print('Меняет, нелюдимая, облик твой,')
    print('Чьих невольница ты идей?')
    print('Зачем тебе охотиться на людей?')
    print('Крестик на моей груди,')
    print('На него ты погляди')
    print('У вас есть все предметы и вы побеждаете колдуна.')
    print('Поздравляю!')
    b = 1
if k == 1:
    print('Вы умерли. Перепройдите квест заново, чтобы дойти до хорошей концовки.')
